             ...
             <div className="container container-fluid">
                <div className="row f-flex justify-content-around">
                    ...
                    <div className="col-12 col-lg-5 mt-5">
                        ...
                        <button type="button" id="cart_btn" onClick={addToCart} disabled={product.rating.count == 0} className="btn btn-primary d-inline ml-4">Add to Cart</button>

                        <hr />

                        <p>Status: <span id="stock_status" className={product.rating.count > 0 ? 'text-success' : 'text-danger'} >{product.rating.count > 0 ? "In Stock" : "Out of Stock"}</span></p>
